...
##  安卓翻墙应用VPN Servers for OpenVPN + OpenVPN Android(100%可用) 搭配使用, WARP Plus（Cloudflare出品网站1.1.1.1）, 迷雾通, NthLink 
## 苹果手机无需客户端翻墙 (VPN Gate提供), WARP Plus（Cloudflare出品网站1.1.1.1）, NthLink
...
##  Jami（主推）,离线通讯应用Briar(仅安卓版本, 以后主推), Brigefy（近距离使用） -- 2023年10月中旬墙内测试可以使用
...
[动态网](https://free6.freeku6.xyz/21), [新闻](https://github.com/hello-world-1989/cn-news), 海外邮箱订阅最新软件资讯并在Gmail邮箱中设置自动转发到国内邮箱

</details>

<!--1. <a href="#desc">项目简介和推荐vpn</a>-->
<!--2. <a href="#general">VPN Gate 无需客户端翻墙--适用于所有系统--2023年8月中旬墙内测试,网友反馈需要尝试多个IP才能链接成功</a>-->
<!--3. <a href="#android">安卓手机端下载 -- 2023年8月中旬墙内测试</a>-->
<!--4. <a href="#ios">苹果手机苹果电脑下载教程 -- 2023年8月中旬墙内测试</a>-->
...
[李老师不是你老师推文在线版，每小时更新，免翻墙访问](https://github.com/hello-world-1989/cn-news/tree/main/%E6%8E%A8%E7%89%B9/2023/t-Month-6/ay-Day-26)

[拆墙运动推特](https://twitter.com/end_gfw)

海外朋友可以加入[拆墙运动电报Telegram](https://t.me/end_gfw1)

国内朋友加入Jami 群, 查找名称 -> end_gfw1
...
<details>
<summary><a id="general">VPN Gate 无需客户端翻墙--适用于所有系统--2023年8月中旬墙内测试网友反馈需要尝试多个IP才能链接成功</a></summary>


加入Jami 或 Session群组获取最新VPN Gate中继服务器地址
...
>安卓版本12以上建议直接使用 NthLink VPN, WARP Plus, Orbot VPN, 苹果手机使用自带L2TP方式
...
nthlink 2023年8月中旬测试可用，欢迎下载使用并反馈, 如果无法使用， 尝试将DNS更改为 8.8.8.8或 1.1.1.1或 9.9.9.9
...
New Node 结合测试和网友反馈 2023年8月中旬测试可用
...
短期翻墙建议使用以上VPN Gate提供的无需客户端翻墙方式 -- 2023年8月网友反馈需要尝试多个IP才能链接成功
...
NthLink, 如果无法使用， 尝试将DNS更改为 8.8.8.8或 1.1.1.1或 9.9.9.9
...
优先顺序: Session -> Jami -> Skred -> Briar(仅安卓) -> Brigefy（只能近距离使用）
